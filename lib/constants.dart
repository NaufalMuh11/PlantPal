...
class Constants {
  ...
  static var titleTwo = "Find a plant enthusiast friend";
  static var descriptionTwo = "Are you a plant enthusiast? Connect with other plant enthusiasts in our community.";
